...
<template>
    ...
    <header class="bg-modern-yellow-default/95 text-white relative w-full p-2 pr-3 flex flex-wrap flex-row justify-between items-center text-center overflow-clip">

        <!-- Site Icon & Title: -->
        <div id="header_siteTitle" class="!cursor-pointer flex justify-center items-center flex-row gap-2" title="Sessions Discord Bot">
        ...
        <div class="flex-wrap flex-row gap-3 hidden sm:!flex">
            ...
            <!-- View Dashboard: -->
            <button v-if="userLoggedIn" title="Invite Bot to Discord Server" class="bg-modern-purple-discord pl-1 pr-2 py-2 rounded-md !cursor-pointer font-semibold flex flex-row items-center justify-center hover:scale-110 active:scale-95 transition-all shadow-md shadow-black/35">
                <span class="material-symbols-rounded !h-6 !w-6 select-none !cursor-pointer">
                    build
                </span>
                <p>
