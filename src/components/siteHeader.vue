...
<template>
    ...
    <header class="bg-modern-yellow-default z-10 fixed top-0 text-white w-full p-2 pr-3 flex flex-wrap flex-row justify-between items-center text-center overflow-clip">
        ...
        <div class="flex flex-wrap justify-center items-center content-center gap-3">
            ...
            <div v-if="!titleOnlyHeader" class="flex-wrap flex-row gap-3 hidden sm:!flex">
                ...
                <button v-if="!userLoggedIn" @click="signInUsingDiscord" title="Sign in with Discord" class="bg-modern-purple-discord px-3 py-2 font-semibold rounded-md cursor-pointer flex items-center hover:scale-105 active:scale-95 transition-all shadow-md shadow-black/35">
            ...
            <div class="relative flex justify-start flex-col right-0 w-65 max-w-[90%] h-full bg-modern-dark-blue-default transition-all">
                ...
                <main class="flex flex-wrap flex-col justify-between items-center content-center flex-1">
                    ...
                    <ol class="flex flex-wrap justify-center items-center p-2 gap-2">
                        ...
                        <!-- Discord Login -->
                        <li v-if="!userLoggedIn" @click="signInUsingDiscord()" class="w-full h-fit p-2 gap-1.5 cursor-pointer hover:bg-gray-500 rounded-sm active:scale-90 transition-all flex flex-nowrap items-center content-center justify-start">
                        ...
                        <!-- Dashboard -->
                        <li v-if="userLoggedIn && route.name !== 'dashboard'" @click="()=>{dashboard(), closeNav()}" class="w-full h-fit p-2 gap-1.5 cursor-pointer hover:bg-gray-500 rounded-sm active:scale-90 transition-all flex flex-nowrap items-center content-center justify-start">
                    ...
                    <ol class="flex flex-wrap justify-center items-center p-2 gap-2">
                        ...
                        <!-- Account -->
                        <div v-if="userLoggedIn" class="w-[95%] flex flex-nowrap flex-col justify-center items-center gap-1">
                            <li class="w-full flex flex-nowrap flex-row justify-center items-center gap-1">
                                <div class="h-[1.5px] w-[95%] bg-gray-500/50"> </div>
                                <h1 class="text-nowrap text-sm text-gray-500/80"> 
                                    My Account
                                </h1>
                            ...
                            <!-- User Signout: -->
                            <li @click="()=>{logoutUser(), closeNav(), homepage()}" class="w-full p-2 gap-1.5 cursor-pointer hover:bg-gray-500 rounded-sm active:scale-90 transition-all flex flex-nowrap items-center content-center justify-start">
