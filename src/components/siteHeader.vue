    ...
    <header class="bg-modern-yellow-default z-10 fixed top-0 text-white w-full gap-3 p-2 pr-3 flex flex-nowrap flex-row justify-between items-center text-center overflow-clip">
        ...
        <div class="flex flex-nowrap justify-center items-center content-center gap-3">
            ...
            <div v-if="!titleOnlyHeader" class="flex-wrap justify-end flex-row gap-3 hidden sm:!flex">
                ...
                <button v-if="!userLoggedIn" @click="auth.signInUsingDiscord" title="Sign in with Discord" class="bg-modern-purple-discord px-3 py-2 font-semibold rounded-md cursor-pointer flex items-center hover:scale-105 active:scale-95 transition-all shadow-md shadow-black/35">
            ...
            <main class="flex flex-wrap flex-col justify-between items-center content-center flex-1">
                ...
                <ol class="flex flex-wrap justify-center items-center p-2 gap-2">
                    ...
                    <div class="w-full flex flex-nowrap flex-col justify-center items-center gap-2">
                        ...
                        <!-- Discord Login -->
                        <li v-if="!userLoggedIn" @click="auth.signInUsingDiscord()" class="w-full h-fit p-2 gap-1.5 cursor-pointer hover:bg-gray-500 rounded-sm active:scale-90 transition-all flex flex-nowrap items-center content-center justify-start">
