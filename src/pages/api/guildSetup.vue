<script setup>
    ...
    // UI:
    import { CalendarCog, EyeOff, FilePlus2, Info, Link2Icon, LockIcon, PlayCircleIcon, PlaySquareIcon, SparklesIcon, Trash2, TriangleAlert } from 'lucide-vue-next';
...
<template>
    ...
    <main class="text-white w-full bg-black/30 text-center flex gap-2 flex-1 flex-col flex-wrap justify-start items-center content-center">
        ...
        <!-- Full Setup Wrap: -->
        <section v-show="!deferSetupContent" class="w-full gap-4 md:w-[80%] p-3 flex justify-center flex-1 flex-wrap items-center content-center flex-col">

            <!-- Information: -->
            <Card v-show="!setupStarted" class="
                    w-[85%]
                ...
                <template #content>
                    ...
                    <div class="flex flex-col justify-center items-center gap-5 ">
                        ...
                        <div class="flex h-full animate-gap justify-center items-center content-center flex-row">
                        ...
                        <Button
                            ...
                            class="!gap-1"
                        >
                            <PlayCircleIcon size="20" stroke-width="2.5" />
                            <p>Begin Setup</p>
                        </Button>
            ...
            <!-- Guild Setup Steps: -->
            <Stepper v-show="setupStarted" :value="currentStep" @update:value="onStepChange" linear
...
<style scoped>
    ...
    /* Sessions & Guild Icon Animation */
    .animate-gap{
        animation: animation-gap 3.55s infinite alternate both linear;
    }

    @keyframes animation-gap {
        0%, 30%{
            gap: 8px;
        }
