<script setup>
    ...
    // Variables:
    const redirectTime = 5; // Seconds till each redirect
...
<template>
    ...
    <main class=" text-white text-shadow-md text-shadow-black/30 gap-2 p-3 text-center flex-1 flex-col flex flex-wrap justify-center items-center content-center">
        
        <div class="gap-4 py-8 bg-modern-yellow-default w-[90%] sm:w-120 shadow-sm rounded-lg shadow-black/80 flex flex-wrap flex-col justify-center items-center content-center">
            ...
            <div class="gap-0.5 text-black/70 mt-2 flex flex-wrap flex-col justify-center items-center content-center">
                ...
                <p class="text-[11px] px-5 font-light"> If you're not automatically redirected you can <a @click="homepage" title="Go Home" class="cursor-pointer hover:underline text-blue-700">click here</a>.</p>
            </div>
