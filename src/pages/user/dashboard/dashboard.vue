...
<template>
    <div id="userDashboardPage" class=" flex flex-1 max-w-full w-full flex-col justify-start items-center gap-3 p-3 flex-wrap">
        ...
        <section v-else-if="pageReady" class="flex flex-wrap gap-7 p-7 flex-1 h-full w-full justify-center items-center content-start">
            ...
            <!-- Todays Outlook: -->
            <div class="flex flex-col overflow-clip justify-between w-75 max-w-[85%] bg-zinc-900 ring-2 ring-ring items-center rounded-md">
            ...
            <div hidden class="flex relative flex-col overflow-clip justify-between w-75 max-w-[85%] bg-zinc-900 ring-2 ring-ring items-center rounded-md">
